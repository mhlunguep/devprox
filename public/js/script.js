    ...
    $(".add-subcategory").on('click', function (e) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          $(".notification").css("display", "block").addClass('alert-primary py-1').delay(5000).slideUp(300).html(response.success);
        },
        error: function error(request, _error) {
          ...
          $(".notification").css("display", "block").removeClass('alert-primary').addClass('alert-danger py-1').delay(6000).slideUp(300).html(ul);
        }
      });
      e.preventDefault();
    });
...
(function () {
  ...
  Craft21.admin.changeEvent = function () {
  ...
  Craft21.admin.update = function () {
    ...
    $(".update-category").on('click', function (e) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          var response = JSON.parse(data);
          $(".notification").css("display", "block").addClass('alert-primary py-1').delay(6000).slideUp(300).html(response.success);
        },
        error: function error(request, _error) {
          var errors = JSON.parse(request.responseText);
          var ul = document.createElement('ul');
    ...
    $(".update-subcategory").on('click', function (e) {
      ...
      if (category_id != selected_category_id) {
        //This means that the user is changing the category
...
/* harmony import */ var _craft21_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./craft21.js */ "./resources/assets/js/craft21.js");
/* harmony import */ var _craft21_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_craft21_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _admin_update_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin/update.js */ "./resources/assets/js/admin/update.js");
/* harmony import */ var _admin_update_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_admin_update_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _admin_create_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./admin/create.js */ "./resources/assets/js/admin/create.js");
/* harmony import */ var _admin_create_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_admin_create_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _admin_events_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./admin/events.js */ "./resources/assets/js/admin/events.js");
/* harmony import */ var _admin_events_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_admin_events_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _init_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./init.js */ "./resources/assets/js/init.js");
/* harmony import */ var _init_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_init_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _mdb_min_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mdb.min.js */ "./resources/assets/js/mdb.min.js");
/* harmony import */ var _mdb_min_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_mdb_min_js__WEBPACK_IMPORTED_MODULE_5__);
...
/***/ "./resources/assets/js/craft21.js":
/*!****************************************!*\
  !*** ./resources/assets/js/craft21.js ***!
  \****************************************/
/***/ (() => {
...
(function () {
  ...
  jQuery(function () {
    ...
    switch ($("body").data("page-id")) {
      ...
      case 'adminProduct':
        Craft21.admin.changeEvent();
        break;

      case 'adminCategories':
        Craft21.admin.update();
        Craft21.admin.create();
        break;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcraft21"] = self["webpackChunkcraft21"] || [];
